...
class DownloadController extends Controller
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	public function internalfileupload(Request $request)
	{
		$validator = $request->validate(
			[
		...
		$userDetailsInfo->albumid = $request->albumid;
		...
		return redirect()->route('formsdownloads', ['id' => $request->albumid])->with('status', ' Content has been updated successfully');
	}

	public function editinternal_form(Request $request, $id)
	{
	...
	public function updateainternal_form(Request $request)
	{
		$validator = $request->validate([
			'albumid' => 'required|max:100',
			'attachmentname' => 'required',
	...
	public function deleteinternal_form(Request $request)
	{
	...
	public function infrastructureinternal_forms_downloads_status(Request $request)
	{
	...
	public function edit(Request $request, $id)
	{
		...
		if ($coordinators) {
			return view('myadmin.downloads.edithtml')
				->with('heading', 'Internal forms / Downloads')
				->with('statusArrays', $this->statusArrays)
	...
	// 		return redirect()->route('formsdownloads')->with('status', 'Content has been updated successfully');
	// 	} else {
	// 		return redirect()->route('formsdownloads')->with('status', 'Coordinator not found');
	// 	}
	// }
	////////////////////////////////
	public function removesingledownload(Request $request)
	{
	...
	public function sorttenders(Request $request)
	{
